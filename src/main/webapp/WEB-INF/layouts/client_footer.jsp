	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
				<h3 class="footer-heading mb-4">ZuZuShoe</h3>
				<a href="#" class="block-6"> <img src="${pageContext.request.contextPath }/static/_client/images/hero_1.jpg"
					alt="Image placeholder" class="img-fluid rounded mb-4">
					<h3 class="font-weight-light  mb-0">Một chiếc giày tuyệt sẽ do khách hàng đánh giá!</h3>
					<p>Khai trương 11/10/2019</p>
				</a>
			</div>
			<div class="col-md-6 col-lg-3">
				...
				<div class="block-7">
					<form action="#" method="post">
						<label for="email_subscribe" class="footer-heading">Đăng ký nhận tin miễn phí</label>
			...
			<div class="col-md-12">
				<p>
					...
					All rights reserved <a
						href="https://colorlib.com" target="_blank" class="text-primary">giangboy</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				</p>
			</div>
